...
CREATE TABLE `sesiones_juego` (
  ...
  `nivel_edad` enum('3','4','5-6') COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `sesiones_juego_elementos` (
  ...
  `estudiante_id` bigint unsigned NOT NULL,
  `elemento_id` varchar(60) COLLATE utf8mb4_unicode_ci NOT NULL,
  `tipo_elemento` enum('pieza_cuerpo','pieza_robot','parte_cuerpo','lateralidad','memoria_ronda','laberinto','recorrido_pelota','objeto_semantico','recorrido_precision') COLLATE utf8mb4_unicode_ci NOT NULL,
