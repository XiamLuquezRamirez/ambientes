...
async function cargarTabla(url) {
    ...
    if (res.success) {
        ...
        const tieneFilros = params.has('buscar') || params.has('grado_id') || params.has('perfil_aprendizaje_id') || params.has('estado');
...
$('#perfil_aprendizaje_id').on('change', async function () {
    aplicarFiltros();
});
