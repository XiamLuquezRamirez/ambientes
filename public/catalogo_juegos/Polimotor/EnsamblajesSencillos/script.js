...
function iniciarPartida() {
    const pedido = String(gameConfig.cuerpo || "robot").toLowerCase();
    if (gameConfig.cuerpos && gameConfig.cuerpos[pedido]) {
        cuerpoElegido = pedido;
    } else if (gameConfig.cuerpos) {
        cuerpoElegido = Object.keys(gameConfig.cuerpos)[0];
    } else {
        cuerpoElegido = "robot";
    }
