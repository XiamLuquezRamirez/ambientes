...
@section('content')
    <div class="page-header" style="display:flex;justify-content:space-between;align-items:center">
        <div>
            <h1>Perfiles de Aprendizaje Personalizados Globales</h1>
            <p>Opciones del selector para docentes, agrupadas por perfil de aprendizaje base</p>
        </div>
    ...
    <form id="formBuscarTransitorias" method="GET" action="{{ route('superadmin.perfil-aprendizaje-personalizado.index') }}"
    ...
    <div id="contenedorTablaTransitorias">
        @include('superAdmin.perfilAprendizajePersonalizado._tabla')
    </div>
...
@push('scripts')
    <script>
        (function() {
            window.URL_TRANSITORIAS = @json(route('superadmin.perfil-aprendizaje-personalizado.index'));
