...
<div class="modal fade modal-info-condicion modal-info-condicion-detalle" id="modalInfoCondicion" tabindex="-1"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-xl ic-dialog-condicion">
        <div class="modal-content ic-modal-shell">
            <div class="ic-acciones-condicion-bar" aria-label="Acciones de la condición">
                <button type="button" class="ic-btn-accion-condicion ic-btn-maximizar-condicion" title="Maximizar"
                    aria-label="Maximizar">
                    <i class="fa-solid fa-expand" aria-hidden="true"></i>
                </button>
                <button type="button" class="ic-btn-volver-exterior ic-btn-volver-principal"
                    aria-label="Volver a condiciones">
                    <i class="fa-solid fa-arrow-left"></i> Volver
                </button>
            </div>
            <div class="modal-body ic-modal-body-padded ic-modal-body-condicion">
...
<div class="modal fade modal-info-condicion modal-info-condicion-contenido" id="modalInfoCondicionContenido"
    ...
    <button type="button" class="ic-btn-volver-exterior ic-btn-volver-seccion" data-bs-dismiss="modal"
        aria-label="Volver a la condición">
        <i class="fa-solid fa-arrow-left"></i> Volver
    </button>
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg ic-dialog-contenido">
        <div class="modal-content ic-modal-shell" style="background-color: transparent !important;">
            ...
            <div class="modal-body ic-modal-body-padded ic-modal-body-contenido">
                <div id="modalInfoCondicionContenidoBody" class="ic-contenido-html">
                    ...
                    @include('partials.info-condiciones.secciones-embebidas')
                </div>
            </div>
        </div>
    </div>
