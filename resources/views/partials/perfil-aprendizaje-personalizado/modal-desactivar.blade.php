        ...
        <form id="formDesasociarTransitoria" class="modal-content">
            <div class="modal-header">
                ...
                <div class="flex-grow-1">
                    <h5 class="modal-title mb-0" id="modalDesasociarTransitoriaLabel">Desactivar perfil personalizado
                    </h5>
            ...
            <div class="modal-body d-grid gap-3">
                ...
                <div>
                    ...
                    <textarea id="observacion_cierre" name="observacion_cierre" class="form-control" rows="4" required minlength="20"
                        maxlength="2000"
