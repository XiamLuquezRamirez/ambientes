<div class="row p-2 container-configuracion-pin" name="configuracion_pin">
    <div class="col-md-12">
        <div class="form-group">
            <h5 class="mb-4 titulo-configuracion-pin" style="font-weight: 600;">Seleccione 3 figuras para
                conformar el PIN de acceso del estudiante</h5>
            <div class="pin-container">
                <div class="pin-item" data-pin-slot="1"></div>
                <div class="pin-item" data-pin-slot="2"></div>
                <div class="pin-item" data-pin-slot="3"></div>
            </div>
