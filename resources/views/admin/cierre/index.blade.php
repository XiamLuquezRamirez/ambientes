...
══════════════════════════════════════════ --}}
    <div id="paso2" style="display:none">
        <div class="c-card">
            ...
            <div id="listaP2" style="border:1px solid #E2E8F0;border-radius:12px;max-height:440px;overflow-y:auto">
...
@push('scripts')
    ...
    `).join('');
        ...
        `;
                ...
                const [bg, border, color] = _estado === 'graduado' ? ['#FEF3C7', '#FCD34D', '#92400E'] : ['#FEF2F2',
                    '#FECACA', '#991B1B'
                ];
