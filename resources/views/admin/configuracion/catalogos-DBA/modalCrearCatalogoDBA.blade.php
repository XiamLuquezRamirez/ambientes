        ...
        <div class="modal-content">
            ...
            <div class="modal-body p-4">
                <form id="formCrearCatalogoDBA" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label class="form-label fw-bold" for="codigo">Código de referencia institucional</label>
                                <input type="text" id="codigo" name="codigo" class="form-control"
                                    placeholder="Ej: DBA-IED-J-ART-01" required maxlength="50">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" form="formCrearCatalogoDBA" id="btnCrearCatalogoDBA" class="btn btn-primary">
                    <i class="fa-solid fa-floppy-disk"></i> Crear DBA personalizado</button>
            </div>
        </div>
    </div>
</div>
