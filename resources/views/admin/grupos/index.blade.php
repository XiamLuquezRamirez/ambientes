...
.grado-edad   { font-size: .78rem; color: #64748B; }
.grado-bloque-body { padding: 14px 20px; }
...
.grupo-nombre-txt { font-weight: 600; font-size: .9rem; color: #1E293B; }
.grupo-chip {
...
.link-agregar-grupo {
    ...
    font-size: .82rem; color: #2563EB; cursor: pointer;
}
...
.campo-error { color: #DC2626; font-size: .78rem; margin-top: 4px; }
</style>
@endpush
...
<div class="page-header" style="display:flex;justify-content:space-between;align-items:center">
    ...
    <div style="display:flex;gap:10px;align-items:center">
        <select class="form-select form-select-sm" style="width:110px"
                onchange="window.location.href='?anio='+this.value">
                ...
                <form id="formGrupo">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" id="grupoAnio" name="anio_lectivo"
                               class="form-control" value="{{ $anio }}"
                               min="2024" max="2030" readonly
...
const URL_STORE  = "{{ route('admin.grupos.store') }}";
const URL_UPDATE = "{{ route('admin.grupos.update', ':id') }}";
const URL_DESTROY= "{{ route('admin.grupos.destroy', ':id') }}";
