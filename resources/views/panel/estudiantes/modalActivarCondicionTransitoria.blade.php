{{-- Modal: activar condición transitoria (panel docente) --}}
@php
...
<div class="modal fade" id="modalCondicionTransitoria" tabindex="-1" aria-labelledby="modalCondicionTransitoriaLabel"
    ...
    <div class="modal-dialog modal-dialog-centered">
        <form method="POST" action="{{ route('panel.estudiantes.condicion-transitoria.activar', $estudiante) }}"
            ...
            <div class="modal-header">
                ...
                <div class="flex-grow-1">
                    <h5 class="modal-title mb-0" id="modalCondicionTransitoriaLabel">Activar condición transitoria</h5>
            ...
            <div class="modal-body" style="display:grid;gap:14px;">
                <div>
                    <label class="form-label fw-semibold" for="ct_select_trigger">Condición transitoria</label>
                    ...
                    <div class="ct-select" id="ctSelect">
                        <button type="button" class="ct-select-trigger" id="ct_select_trigger">
                            <span class="ct-select-label is-placeholder" id="ctSelectLabel">Selecciona una condición…</span>
                        ...
                        <div class="ct-select-panel">
                            ...
                            <div class="ct-select-list" id="ctSelectList">
                                ...
                                @empty
                                    <div class="ct-select-empty">No hay condiciones habilitadas</div>
                                @endforelse
                ...
                <div>
                    ...
                    <textarea name="observacion" id="observacion_ct" class="form-control" rows="4" required
                        ...
                        placeholder="Describe por qué se activa esta condición transitoria…"></textarea>
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary" id="btnActivarCondicionTransitoria">
        ...
        (function() {
            ...
            options().forEach((opt) => {
                opt.addEventListener('click', () => {
                    ...
                    label.textContent = opt.dataset.label || 'Selecciona una condición…';
            ...
            form?.addEventListener('submit', (e) => {
                if (!hidden.value) {
                    ...
                    Swal.fire({
                        ...
                        text: 'Debes elegir una condición transitoria antes de activarla.',
            ...
            document.getElementById('modalCondicionTransitoria')?.addEventListener('hidden.bs.modal', () => {
                cerrar();
                hidden.value = '';
                label.textContent = 'Selecciona una condición…';
