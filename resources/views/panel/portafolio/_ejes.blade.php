                    ...
                    <div class="mod-ejes-group" data-modulo-id="{{ $modulo->id }}"
                        ...
                        <div class="modulos-seccion modulos-seccion-colegio" data-seccion="colegio">
                            <div class="modulos-seccion-head">
                                ...
                                <span class="modulos-seccion-hint">Visibles para todos · solo edita los que usted
                                    creó</span>
                            </div>
                        ...
                        <div class="mod-ejes-foot">
                            ...
                            @else
                                <span class="text-muted small">
                                    El módulo está inactivo. Solicite al administrador que lo active para gestionar
                                    ejes.
                                </span>
                            @endif
                        </div>
