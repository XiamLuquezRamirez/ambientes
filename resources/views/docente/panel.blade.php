...
<head>
    ...
    <style>
        ...
        * {
        ...
        .nav a.active {
            color: var(--color-ambiente);
            border-left-color: var(--color-ambiente);
            background: rgba(var(--color-ambiente-rgb, 15, 110, 86), 0.1);
            font-weight: 600;
        }
        ...
        .alert-success {
            ...
            border: 1px solid var(--color-ambiente);
            color: #6EE7B7;
            padding: 12px 16px;
            border-radius: 8px;
            margin-bottom: 20px;
    ...
    <aside class="sidebar">
        ...
        <nav class="nav">
            <a href="{{ route('panel.estudiantes') }}"
                class="{{ request()->routeIs('panel.estudiantes*') ? 'active' : '' }}">
                🧒 Estudiantes
            </a>
            <a href="{{ route('panel.planeacion') }}"
                class="{{ request()->routeIs('panel.planeacion*') ? 'active' : '' }}">
                📅 Planeación
            </a>
            ...
            <a href="{{ route('panel.portafolio') }}"
                class="{{ request()->routeIs('panel.portafolio*') ? 'active' : '' }}">
                📁 Portafolios
            </a>
            <a href="{{ route('panel.inclusion') }}"
                class="{{ request()->routeIs('panel.inclusion*') ? 'active' : '' }}">
                ♿ Inclusión
            </a>
        </nav>
    </aside>
