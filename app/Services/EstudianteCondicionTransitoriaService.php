...
class EstudianteCondicionTransitoriaService
{
    ...
    public function autorizarCondicionInstitucion(CondicionTransitoria $condicion, int $institucionId): void
    {
    ...
    /**
     * @return Collection<int, EstudianteCondicionTransitoria>
     */
    public function asignacionesActivas(
        CondicionTransitoria $condicion,
        int $institucionId,
        ?int $docenteId = null
    ): Collection {
        $consulta = EstudianteCondicionTransitoria::query()
    ...
    {
        $filas = EstudianteCondicionTransitoria::query()
    ...
    public function serializarAsignacion(EstudianteCondicionTransitoria $asignacion, bool $puedeDesasociar): array
    {
    ...
    public function desasociar(
        EstudianteCondicionTransitoria $asignacion,
        string $motivoCierre,
